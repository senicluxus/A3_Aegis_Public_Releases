class Atlas_O_C_Marine_APC_Wheeled_02_rcws_v2_F: APC_Wheeled_02_base_v2_F
{
	...
	scopeCurator = public;
	side = TEast;
	faction = Atlas_OPF_PLANMC_F;
	crew = Atlas_O_C_Marine_Crew_F;
	typicalCargo[] = {Atlas_O_C_Marine_F};
...
class Atlas_O_C_Marine_APC_Wheeled_02_unarmed_lxWS: O_T_APC_Wheeled_02_unarmed_lxWS
{
    scope = public;
	scopeCurator = public;
