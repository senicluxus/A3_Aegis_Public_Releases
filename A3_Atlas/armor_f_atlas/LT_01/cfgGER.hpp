...
class Atlas_B_G_LT_01_AT_F: LT_01_AT_base_F
{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_G_LT_01_AT_F.jpg";
	side = TWest;
...
{
	author = $STR_A3_A_AveryTheKitty;
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_G_LT_01_scout_F.jpg";
	side = TWest;
	faction = Atlas_BLU_G_F;
	crew = Atlas_B_G_Crew_F;
	typicalCargo[] = {Atlas_B_G_Soldier_F};
...
{
	author = $STR_A3_A_AveryTheKitty;
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_G_LT_01_AA_F.jpg";
	side = TWest;
	faction = Atlas_BLU_G_F;
	crew = Atlas_B_G_Crew_F;
	typicalCargo[] = {Atlas_B_G_Soldier_F};
...
{
	author = $STR_A3_A_AveryTheKitty;
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_G_LT_01_cannon_F.jpg";
	side = TWest;
	faction = Atlas_BLU_G_F;
	crew = Atlas_B_G_Crew_F;
	typicalCargo[] = {Atlas_B_G_Soldier_F};
