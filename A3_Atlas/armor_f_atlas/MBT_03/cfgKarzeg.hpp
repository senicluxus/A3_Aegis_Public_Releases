/* Karzeghistan */
class Atlas_B_K_MBT_03_base_F: MBT_03_base_F
{
	author = $STR_A3_A_BranFlakes;
	crew = Atlas_B_K_Crew_F;
	typicalCargo[] = {Atlas_B_K_Crew_F};
...
class Atlas_B_K_MBT_03_cannon_F: Atlas_B_K_MBT_03_base_F
{
	author = $STR_A3_A_BranFlakes;
	class SimpleObject
	{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_K_MBT_03_cannon_F.jpg";
	scope = public;
	displayName = $STR_A3_A_CfgVehicles_B_G_MBT_03_cannon_F0;
