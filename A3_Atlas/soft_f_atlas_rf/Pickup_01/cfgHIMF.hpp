class Atlas_B_H_Pickup_F: Pickup_01_base_rf
{
	author = $STR_A3_A_BranFlakes;
	side = TWest;
	scope = public;
	scopeCurator = public;
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_H_Pickup_F.jpg";
...
class Atlas_B_H_Pickup_Comms_F: Pickup_comms_base_rf
{
	author = $STR_A3_A_BranFlakes;
	side = TWest;
	scope = public;
	scopeCurator = public;
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_H_Pickup_Comms_F.jpg";
	faction = Atlas_BLU_H_F;
	crew = "Atlas_B_H_Soldier_F";
	typicalCargo[] = {"Atlas_B_H_Soldier_F"};
	textureList[] = {"Jungle",1};
...
class Atlas_B_H_Pickup_HMG_F: Pickup_01_hmg_base_rf
{
	author = $STR_A3_A_BranFlakes;
	side = TWest;
	scope = public;
	scopeCurator = public;
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_H_Pickup_HMG_F.jpg";
	faction = Atlas_BLU_H_F;
	crew = "Atlas_B_H_Soldier_F";
	typicalCargo[] = {"Atlas_B_H_Soldier_F"};
	textureList[] = {"Jungle",1};
...
class Atlas_B_H_Pickup_aat_F: Pickup_01_aat_base_rf
{
	author = $STR_A3_A_BranFlakes;
	side = TWest;
	scope = public;
	scopeCurator = public;
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_H_Pickup_aat_F.jpg";
	faction = Atlas_BLU_H_F;
	crew = "Atlas_B_H_Soldier_F";
	typicalCargo[] = {"Atlas_B_H_Soldier_F"};
	textureList[] = {"Jungle",1};
...
class Atlas_B_H_Pickup_AT_F: Aegis_Pickup_01_AT_base_RF
{
	author = $STR_A3_A_BranFlakes;
	side = TWest;
	scope = public;
	scopeCurator = public;
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_H_Pickup_AT_F.jpg";
	faction = Atlas_BLU_H_F;
	crew = "Atlas_B_H_Soldier_F";
	typicalCargo[] = {"Atlas_B_H_Soldier_F"};
	textureList[] = {"Jungle",1};
