/* French Cougars */
class Atlas_B_L_Heli_EC_03_RF: Heli_EC_03_base_RF
{
	...
	scope = public;
	scopeCurator = public;
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_L_Heli_EC_03_RF.jpg";
	side = TWest;
...
class Atlas_B_L_Heli_EC_04_military_RF: Heli_EC_04_military_base_RF
{
	author = $STR_A3_A_BranFlakes;
	...
	scope = public;
	scopeCurator = public;
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_L_Heli_EC_04_military_RF.jpg";
	side = TWest;
	faction = Atlas_BLU_L_F;
	crew = Atlas_B_L_Helipilot_F;
	typicalCargo[] = {Atlas_B_L_Soldier_Lite_F};
