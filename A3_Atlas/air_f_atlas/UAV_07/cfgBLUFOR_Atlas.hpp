/* Germany */
class Atlas_B_G_UAV_07_F: Aegis_UAV_07_base_F
{
    ...
    editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_G_UAV_07_F.jpg";
    scope = public;
    scopeCurator = public;
...
class Atlas_B_G_UAV_07_ard_F: Atlas_B_G_UAV_07_F
{
    scope = public;
	scopeCurator = public;
	side = TWest;
