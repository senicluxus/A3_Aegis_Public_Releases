class Atlas_I_AR_Ejection_Seat_Plane_CAS_02_F: Ejection_Seat_Plane_CAS_02_base_F
{
	class SimpleObject
	{
		eden = false;
...
class Atlas_I_AR_Plane_CAS_02_dynamicLoadout_ghex_F: O_Plane_CAS_02_dynamicLoadout_F
{
	author = $STR_A3_A_BranFlakes;
    class SimpleObject
	{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_I_AR_Plane_CAS_02_dynamicLoadout_ghex_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TGuerrila;
	faction = Atlas_IND_AR_F;
	crew = Atlas_I_AR_Pilot_F;
	typicalCargo[] = {Atlas_I_AR_Pilot_F};
	textureList[] =
	{
		ardistan,1
	};
	...
	{
		EjectionSeatClass = Atlas_I_AR_Ejection_Seat_Plane_CAS_02_F;
	};
};