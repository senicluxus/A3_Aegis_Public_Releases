class Atlas_I_UNO_UAV_06_F: UAV_06_base_F
{
	...
	class assembleInfo
	{
		...
		assembleTo = "";
		displayName = "";
		dissasembleTo[] = {Atlas_I_UNO_UAV_06_backpack_F};
	};
	hiddenSelectionsTextures[] = {"\A3_Atlas\Air_F_Atlas\UAV_06\Data\I_I_UAV_06_CO.paa"};
};
class Atlas_I_UNO_UAV_06_medical_F: UAV_06_medical_base_F
{
	...
	class assembleInfo
	{
		...
		assembleTo = "";
		displayName = "";
		dissasembleTo[] = {Atlas_I_UNO_UAV_06_medical_backpack_F};
	};
...
class Box_I_UNO_UAV_06_F: Box_UAV_06_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
	...
	scope = public;
	scopeCurator = public;
	displayName = $STR_A3_A_CfgVehicles_Box_I_UNO_UAV_06_F0;
	hiddenSelectionsTextures[] = {"\A3\Air_F_Orange\UAV_06\Data\B_UAV_06_CO.paa"};
};
class Box_I_UNO_UAV_06_medical_F: Box_UAV_06_medical_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
	...
	scope = public;
	scopeCurator = public;
	displayName = $STR_A3_A_CfgVehicles_Box_I_UNO_UAV_06_medical_F0;
	hiddenSelectionsTextures[] =
	{
		"\A3\Air_F_Orange\UAV_06\Data\B_UAV_06_medical_CO.paa",
		"\A3\Air_F_Orange\UAV_06\Data\B_UAV_06_medical_CO.paa"
...
class Atlas_I_UNO_UAV_06_backpack_F: UAV_06_backpack_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	scopeCurator = public;
	displayName = $STR_A3_A_CfgVehicles_I_UNO_UAV_06_backpack_F0;
	faction = Atlas_IND_UNO_F;
	...
	{
		displayName = $STR_A3_A_CfgVehicles_I_UNO_UAV_06_backpack_F_assembleInfo0;
		assembleTo = Atlas_I_UNO_UAV_06_F;
	};
};
class Atlas_I_UNO_UAV_06_medical_backpack_F: UAV_06_medical_backpack_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	scopeCurator = public;
	displayName = $STR_A3_A_CfgVehicles_I_UNO_UAV_06_medical_backpack_F0;
	faction = Atlas_IND_UNO_F;
	...
	class assembleInfo: assembleInfo
	{
		displayName = $STR_A3_A_CfgVehicles_I_UNO_UAV_06_medical_backpack_F_assembleInfo0;
		assembleTo = Atlas_I_UNO_UAV_06_medical_F;
	};
};
class Atlas_I_UNO_wdl_UAV_06_F: Atlas_I_UNO_UAV_06_F
{
	faction = Atlas_IND_UNO_wdl_F;
};
class Atlas_I_UNO_wdl_UAV_06_medical_F: Atlas_I_UNO_UAV_06_medical_F
{
	faction = Atlas_IND_UNO_wdl_F;
};