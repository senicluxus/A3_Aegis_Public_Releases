...
class Atlas_B_H_Heli_Light_01_F: I_Heli_Light_01_F
{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_H_Heli_Light_01_F.jpg";
	scope = public;
	...
	hiddenSelectionsTextures[] = {"\A3_Atlas\Air_F_Atlas\Heli_Light_01\Data\Heli_Light_01_ext_Jungle_CO.paa"};
...
class Atlas_B_H_Heli_Light_01_dynamicLoadout_F: Heli_Light_01_dynamicLoadout_base_F
{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_H_Heli_Light_01_dynamicLoadout_F.jpg";
	scope = public;
	scopeArsenal = private;
	forceInGarage = false;
	side = TWest;
