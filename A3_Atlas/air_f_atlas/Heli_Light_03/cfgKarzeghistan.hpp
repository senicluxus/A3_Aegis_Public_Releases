...
class Atlas_B_K_Heli_light_03_dynamicLoadout_F: Heli_light_03_dynamicLoadout_base_F
{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_K_Heli_light_03_dynamicLoadout_F.jpg";
	scope = public;
	side = TWest;
...
class Atlas_B_K_Heli_light_03_unarmed_F: Heli_light_03_unarmed_base_F
{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_K_Heli_light_03_unarmed_F.jpg";
	scope = public;
	side = TWest;
	faction = Atlas_BLU_K_F;
    crew = Atlas_B_K_Helipilot_F;
	...
	hiddenSelectionsTextures[] = {"\A3_Atlas\Air_F_Atlas\Heli_Light_03\Data\Heli_Light_03_base_kzg_CO.paa"};
	textureList[] =
    {
        KZG,1
    };
