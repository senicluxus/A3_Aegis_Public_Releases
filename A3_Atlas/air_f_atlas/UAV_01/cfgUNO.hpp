class Atlas_I_UNO_UAV_01_F: UAV_01_base_F
{
	...
	class assembleInfo
	{
		...
		assembleTo = "";
		displayName = "";
		dissasembleTo[] = {Atlas_I_UNO_UAV_01_backpack_F};
	};
	hiddenSelectionsTextures[] = {"\A3\Drones_F\Air_F_Gamma\UAV_01\Data\UAV_01_CO.paa"};
	textureList[] = {Blufor,1};
};
class Atlas_I_UNO_wdl_UAV_01_F: Atlas_I_UNO_UAV_01_F
{
    faction = Atlas_IND_UNO_wdl_F;
};
class Atlas_I_UNO_UAV_01_backpack_F: Weapon_Bag_Base
{
	author = $STR_A3_A_Ravenholme;
	mapSize = 0.6;
	scope = public;
	scopeCurator = public;
	displayName = $STR_A3_A_CfgVehicles_I_UNO_UAV_01_backpack_F0;
	...
	{
		base = "";
		displayName = $STR_A3_A_CfgVehicles_I_UNO_UAV_01_backpack_F_assembleInfo0;
		assembleTo = Atlas_I_UNO_UAV_01_F;
	};
};