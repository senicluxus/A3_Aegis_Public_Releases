class Atlas_B_K_Plane_Fighter_01_F: B_Plane_Fighter_01_F
{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_B_K_Plane_Fighter_01_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TWest;
	faction = Atlas_BLU_K_F;
	crew = Atlas_B_K_Pilot_F;
	typicalCargo[] = {Atlas_B_K_Pilot_F};
	...
	{
		EjectionSeatClass = Atlas_B_K_Ejection_Seat_Plane_Fighter_01_F;
	};
};

class Atlas_B_K_Ejection_Seat_Plane_Fighter_01_F: Ejection_Seat_Plane_Fighter_01_base_F
{
	class SimpleObject
	{
		eden = false;
	...
	crew = Atlas_B_K_Fighter_Pilot_F;
};