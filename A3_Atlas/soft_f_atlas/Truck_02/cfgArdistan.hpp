class Atlas_I_AR_Truck_02_F: O_Truck_02_covered_F
{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_I_AR_Truck_02_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TGuerrila;
...
class Atlas_I_AR_Truck_02_transport_F: O_Truck_02_transport_F
{
    author = $STR_A3_A_BranFlakes;
	class SimpleObject
	{
    ...
    editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_I_AR_Truck_02_transport_F.jpg";
    scope = public;
    scopeCurator = public;
    side = TGuerrila;
    faction = Atlas_IND_AR_F;
...
class Atlas_I_AR_Truck_02_box_F: O_Truck_02_box_F
{
	author = $STR_A3_A_BranFlakes;
	class SimpleObject
	{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_I_AR_Truck_02_box_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TGuerrila;
	faction = Atlas_IND_AR_F;
...
class Atlas_I_AR_Truck_02_medical_F: O_Truck_02_medical_F
{
	author = $STR_A3_A_BranFlakes;
	class SimpleObject
	{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_I_AR_Truck_02_medical_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TGuerrila;
	faction = Atlas_IND_AR_F;
...
class Atlas_I_AR_Truck_02_Ammo_F: O_Truck_02_Ammo_F
{
	author = $STR_A3_A_BranFlakes;
	class SimpleObject
	{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_I_AR_Truck_02_Ammo_F.jpg";
	scope = public;
	scopeCurator = public;
...
class Atlas_I_AR_Truck_02_fuel_F: O_Truck_02_fuel_F
{
	author = $STR_A3_A_BranFlakes;
	class SimpleObject
	{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_I_AR_Truck_02_fuel_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TGuerrila;
	faction = Atlas_IND_AR_F;
...
class Atlas_I_AR_Truck_02_cargo_F: Truck_02_cargo_base_lxWS
{
	author = $STR_A3_A_BranFlakes;
	class SimpleObject
		{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_I_AR_Truck_02_cargo_F.jpg";
	scope = public;
	scopeCurator = public;
...
class Atlas_I_AR_Truck_02_flatbed_F: Truck_02_flatbed_base_lxWS
{
	author = $STR_A3_A_BranFlakes;
	class SimpleObject
		{
	...
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_I_AR_Truck_02_flatbed_F.jpg";
	scope = public;
	scopeCurator = public;
...
class Atlas_I_AR_Truck_02_MRL_F: O_Truck_02_MRL_F
{
	author = $STR_A3_A_BranFlakes;
	scope = public;
	scopeCurator = public;
	editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\Atlas_I_AR_Truck_02_MRL_F.jpg";
	side = TGuerrila;
	faction = Atlas_IND_AR_F;
	crew = Atlas_I_AR_Soldier_F;
	typicalCargo[] = {Atlas_I_AR_Soldier_F};
