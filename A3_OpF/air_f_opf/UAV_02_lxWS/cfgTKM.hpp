...
{
	class SimpleObject{};
	editorPreview = "\A3_OpF\editorpreviews_f_opf\Data\CfgVehicles\Opf_I_I_UAV_02_IED_lxWS.jpg";
	scope = public;
	scopeCurator = public;
	side = TGuerrila;
	faction = Opf_IND_I_F;
	...
	class assembleInfo
	{
		...
		assembleTo = "";
		displayName = "";
		dissasembleTo[] = {Opf_I_I_UAV_02_IED_backpack_lxWS};
	};
};
class Opf_I_I_UAV_02_IED_backpack_lxWS: Weapon_Bag_Base
{
	mapSize = 0.6;
	scope = protected;
	scopeCurator = protected;
	displayName = $STR_A3_A_CfgVehicles_Opf_I_I_UAV_IED_lxWS_backpack_F0;
	...
	class assembleInfo: assembleInfo
	{
		...
		assembleTo = Opf_I_I_UAV_02_IED_lxWS;
	};
};