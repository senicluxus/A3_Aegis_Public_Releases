class Opf_O_S_Truck_02_F: O_Truck_02_covered_F
{
	...
	editorPreview = "\A3_Opf\EditorPreviews_F_Opf\Data\CfgVehicles\Opf_O_S_Truck_02_F.jpg";
	scope = public;
	scopeCurator = public;
	side = TEast;
	faction = Opf_OPF_S_F;
...
class Opf_O_S_Truck_02_transport_F: O_Truck_02_transport_F
{
	...
	editorPreview = "\A3_Opf\EditorPreviews_F_Opf\Data\CfgVehicles\Opf_O_S_Truck_02_transport_F.jpg";
	scope = public;
	scopeCurator = public;
...
class Opf_O_S_Truck_02_cargo_F: Truck_02_cargo_base_lxWS
{
	...
	editorPreview = "\A3_Opf\EditorPreviews_F_Opf\Data\CfgVehicles\Opf_O_S_Truck_02_cargo_F.jpg";
	scope = public;
	scopeCurator = public;
...
class Opf_O_S_Truck_02_flatbed_F: Truck_02_flatbed_base_lxWS
{
	...
	editorPreview = "\A3_Opf\EditorPreviews_F_Opf\Data\CfgVehicles\Opf_O_S_Truck_02_flatbed_F.jpg";
	scope = public;
	scopeCurator = public;
