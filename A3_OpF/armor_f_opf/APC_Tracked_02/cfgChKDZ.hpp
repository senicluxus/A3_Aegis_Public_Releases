...
class Opf_O_S_APC_Tracked_02_30mm_lxWS: O_APC_Tracked_02_30mm_lxWS
{
    editorPreview = "\A3_Opf\EditorPreviews_F_Opf\Data\CfgVehicles\Opf_O_S_APC_Tracked_02_30mm_lxWS.jpg";
	scope = public;
	scopeCurator = public;
	side = TEast;
	faction = Opf_OPF_S_F;
