/* Partisans */
class Opf_B_P_APC_Wheeled_03_cannon_F: I_APC_Wheeled_03_cannon_F
{
	...
	class TransportMagazines
	{
		...
		mag_xx(Atlas_150Rnd_762x51_Box_Yellow,5);
		...
		mag_xx(1Rnd_SmokeBlue_Grenade_shell,6);
		mag_xx(SmokeShell,8);
		mag_xx(SmokeShellGreen,8);
		mag_xx(SmokeShellOrange,8);
		mag_xx(SmokeShellBlue,8);
		mag_xx(MRAWS_HEAT55_F,4);
        mag_xx(MRAWS_HE_F,2);
	};
	class TransportWeapons
	{
		weap_xx(Aegis_arifle_M4A1_F,2);
	};
