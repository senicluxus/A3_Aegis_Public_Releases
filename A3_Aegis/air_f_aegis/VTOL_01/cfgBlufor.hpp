...
class B_D_VTOL_01_infantry_F: VTOL_01_infantry_base_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\B_D_VTOL_01_infantry_F.jpg";
	scope = public;
	scopeCurator = public;
	displayName = $STR_A3_CfgVehicles_VTOL_01_infantry_base_F0;
	side = TWest;
...
class B_D_VTOL_01_vehicle_F: VTOL_01_vehicle_base_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\B_D_VTOL_01_vehicle_F.jpg";
	scope = public;
	scopeCurator = public;
	displayName = $STR_A3_CfgVehicles_VTOL_01_vehicle_base_F0;
	side = TWest;
...
class B_D_VTOL_01_armed_F: VTOL_01_armed_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\B_D_VTOL_01_armed_F.jpg";
	scope = public;
	scopeCurator = public;
	displayName = $STR_A3_CfgVehicles_VTOL_01_armed_base_F0;
	side = TWest;
