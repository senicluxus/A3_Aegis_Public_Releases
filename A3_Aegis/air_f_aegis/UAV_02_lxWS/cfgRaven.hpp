/*======================================
	Raven Security AP-5s
======================================*/
class Aegis_O_Raven_UAV_02_lxWS: UAV_02_Base_lxWS
{
	class SimpleObject{};
...
class Aegis_I_Raven_UAV_02_lxWS: UAV_02_Base_lxWS
{
	class SimpleObject{};
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\Aegis_O_R_UAV_02_lxWS.jpg";
	scope = public;
	...
	class assembleInfo
	{
		...
		assembleTo = "";
		displayName = "";
		dissasembleTo[] = {Aegis_I_Raven_UAV_02_backpack_lxWS};
	};
   
   lxws_droneWeapon[] = {"arifle_RPK12_F","75rnd_762x39_ak12_mag_f",""};	// weapon, prim mag, sec mag
};
class Aegis_I_Raven_UAV_02_backpack_lxWS: Weapon_Bag_Base
{
	mapSize = 0.6;
	scope = public;
	scopeCurator = public;
	displayName = $STR_A3_A_CfgVehicles_I_Raven_UAV_02_lxWS_backpack_F0;
	...
	class assembleInfo: assembleInfo
	{
		base = "";
		displayName = $STR_A3_A_CfgVehicles_O_R_UAV_02_lxWS_F0;
		assembleTo = Aegis_I_Raven_UAV_02_lxWS;
	};
};