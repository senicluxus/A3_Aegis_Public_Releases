/* LDF */
class Aegis_I_E_APC_Wheeled_01_cannon_v2_F: APC_Wheeled_01_base_v2_F
{
	...
	scope = public;
	scopeCurator = public;
    displayName = $STR_A3_A_CfgVehicles_I_E_APC_Wheeled_01_v2_F0;
	side = TGuerrila;
	faction = IND_E_F;
	crew = I_E_Crew_F;
...
class Aegis_I_E_APC_Wheeled_01_command_lxWS: APC_Wheeled_01_command_base_lxWS
{
    author = $STR_A3_A_Ravenholme;
    editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\Aegis_I_E_APC_Wheeled_01_command_lxWS.jpg"; 
    displayName = $STR_A3_A_CfgVehicles_I_E_APC_Wheeled_01_CV_F0;
	side = TGuerrila;
	faction = IND_E_F;
	crew = I_E_Crew_F;
	typicalCargo[] = {I_E_Crew_F};
...
class Aegis_I_E_APC_Wheeled_01_mortar_lxWS: APC_Wheeled_01_mortar_base_lxWS
{
    author = $STR_A3_A_Ravenholme;
    editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\Aegis_I_E_APC_Wheeled_01_mortar_lxWS.jpg";
    displayName = $STR_A3_A_CfgVehicles_I_E_APC_Wheeled_01_mortar_F0;
    scope = public;
    scopeCurator = public;
    side = TGuerrila;
	faction = IND_E_F;
...
class Aegis_I_E_APC_Wheeled_01_atgm_v2: APC_Wheeled_01_atgm_base_v2
{
    author = $STR_A3_A_BranFlakes;
    scope = public;
    scopeCurator = public;
    editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\Aegis_I_E_APC_Wheeled_01_atgm_v2.jpg";
    displayName = $STR_A3_A_CfgVehicles_I_E_APC_Wheeled_01_atgm_F0;
    side = TGuerrila;
	faction = IND_E_F;
	crew = I_E_Crew_F;
	typicalCargo[] = {I_E_Crew_F};
...
class Aegis_I_E_APC_Wheeled_01_medical_F: B_APC_Wheeled_01_medical_F
{
    author = $STR_A3_A_Ravenholme;
    editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\Aegis_I_E_APC_Wheeled_01_medical_F.jpg";
    displayName = $STR_A3_A_CfgVehicles_I_E_APC_Wheeled_01_medical_F0;
    scope = public;
    scopeCurator = public;
    side = TGuerrila;
	faction = IND_E_F;
...
class Aegis_B_E_APC_Wheeled_01_command_lxWS: Aegis_I_E_APC_Wheeled_01_command_lxWS
{
    author = $STR_A3_A_Ravenholme;
    side = TWest;
	faction = BLU_EAF_F;
...
class Aegis_B_E_APC_Wheeled_01_mortar_lxWS: Aegis_I_E_APC_Wheeled_01_mortar_lxWS
{
    author = $STR_A3_A_Ravenholme;
    side = TWest;
	faction = BLU_EAF_F;
...
class Aegis_B_E_APC_Wheeled_01_atgm_v2: Aegis_I_E_APC_Wheeled_01_atgm_v2
{
    author = $STR_A3_A_Ravenholme;
    side = TWest;
	faction = BLU_EAF_F;
