...
{
    editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\Aegis_O_R_APC_Tracked_02_30mm_lxWS.jpg";
...
class Aegis_O_R_APC_Tracked_02_30mm_ard_lxWS: Aegis_O_R_APC_Tracked_02_30mm_lxWS
{
    faction = OPF_R_ard_F;
	crew = O_R_crew_ard_F;
	typicalCargo[] = {O_R_Soldier_ard_F};
