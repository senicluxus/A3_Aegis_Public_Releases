class CfgVehicles
{
	...
	UNIFORM_HOLDER(Aegis_U_O_CombatFatigues_ghex_F,$STR_A3_A_CfgWeapons_U_O_CombatFatigues_ghex_F0);
	UNIFORM_HOLDER(Aegis_U_O_CombatFatigues_02_ghex_F,$STR_A3_A_CfgWeapons_U_O_CombatFatigues_02_ghex_F0);
	UNIFORM_HOLDER(Aegis_U_O_CombatFatigues_dst_F,$STR_A3_A_CfgWeapons_U_O_CombatFatigues_dst_F0);
	UNIFORM_HOLDER(Aegis_U_O_CombatFatigues_02_dst_F,$STR_A3_A_CfgWeapons_U_O_CombatFatigues_02_dst_F0);
	UNIFORM_HOLDER(Aegis_U_O_CombatFatigues_oli_F,$STR_A3_A_CfgWeapons_U_O_CombatFatigues_oli_F0);
	UNIFORM_HOLDER(Aegis_U_O_CombatFatigues_02_oli_F,$STR_A3_A_CfgWeapons_U_O_CombatFatigues_02_oli_F0);
	UNIFORM_HOLDER(Aegis_U_O_CombatFatigues_khk_F,$STR_A3_A_CfgWeapons_U_O_CombatFatigues_khk_F0);
	UNIFORM_HOLDER(Aegis_U_O_CombatFatigues_02_khk_F,$STR_A3_A_CfgWeapons_U_O_CombatFatigues_02_khk_F0);
	UNIFORM_HOLDER(Aegis_U_O_LightCombatFatigues_ghex_F,$STR_A3_A_CfgWeapons_U_O_LightCombatFatigues_ghex_F0);
	UNIFORM_HOLDER(Aegis_U_O_LightCombatFatigues_dst_F,$STR_A3_A_CfgWeapons_U_O_LightCombatFatigues_dst_F0);
	UNIFORM_HOLDER(Aegis_U_O_LightCombatFatigues_urb_F,$STR_A3_A_CfgWeapons_U_O_LightCombatFatigues_urb_F0);
	...
	UNIFORM_HOLDER(Aegis_U_O_CombatFatigues_02_ruarid_F,$STR_A3_A_CfgWeapons_U_O_CombatFatigues_02_ruarid_F0);
